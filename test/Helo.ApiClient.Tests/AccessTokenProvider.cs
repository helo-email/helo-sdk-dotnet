...
public class AccessTokenProvider(string? token = null) : IAccessTokenProvider
{
        ...
        CancellationToken cancellationToken = new())
    {
        ...
        return token ?? "0199dedfda6b70a8bbc12caa362975bd_msLY5seoK3DSxPmpspMMTh9jpP0s7mkGh3pFIDoLj9Z6H4U2P8Fgm9H7ZMEsKobz";
    }
